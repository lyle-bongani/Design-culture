      ...
      <div className="container mx-auto px-4 py-12 sm:py-14">
        <div className="rounded-2xl bg-gray-100 ring-1 ring-black/10 shadow-[0_12px_30px_rgba(0,0,0,0.18)]">
          <div className="grid items-center gap-8 p-6 sm:p-8 md:grid-cols-2">
            ...
            {/* Right: phone mockup (reuses style similar to ContactCTA) */}
            <div className="relative mx-auto w-full max-w-sm">
              {/* Optional peek element placeholder */}
              <div className="absolute -right-6 bottom-6 hidden h-24 w-24 translate-x-1/2 items-center justify-center overflow-hidden rounded-full bg-white ring-4 ring-gray-200 shadow md:flex">
