...
const CompanySummary: React.FC = () => {
  return (
    <section className="container mx-auto px-4 py-10 sm:py-12">
      <div className="flex flex-col sm:flex-row items-center sm:items-start md:items-center gap-6 rounded-2xl bg-gray-200/70 p-4 sm:p-6 ring-1 ring-black/10 shadow-[0_6px_20px_rgba(0,0,0,0.08)]">
        ...
        <div className="flex -space-x-4 shrink-0">
          {avatars.slice(0, 5).map((src, idx) => (
            <img
              ...
              className="h-14 w-14 shrink-0 rounded-full object-cover ring-4 ring-white grayscale"
            />
          ))}
          {/* Plus circle */}
          <div className="grid h-14 w-14 shrink-0 place-items-center rounded-full bg-[#1F2429] ring-4 ring-white text-white text-2xl font-light">
            +
          </div>
        </div>
